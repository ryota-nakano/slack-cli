...
class SlackMessageAPI {
  ...
  async formatMentionsInText(text, usersCache, usergroupsCache = null) {
    ...
    // Replace user mentions <@USER_ID> with @display_name (yellow text)
    ...
    // Replace group mentions <!subteam^GROUP_ID|@handle> with @group_name (yellow text)
    ...
    // Replace special mentions (yellow text)
